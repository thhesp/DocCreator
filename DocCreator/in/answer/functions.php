...
/**
	@name: loadSections;
	@desc: used to load the Sectiondata from the database;
	@type: FUNCTION;
	@param: int-survey_id;
	@lang: PHP;
	@return: Hashtable;
...
/**
	@name: loadQuestion;
	@desc: used to load the Questiondata from the database;
	@type: FUNCTION;
...
/**
	@name: loadQuestionsIDs;
	@desc: used to load QuestionIDs from the database;
	@type: FUNCTION;
	@param: int-section_id;
	@lang: PHP;
	@return: int Array;
...
/**
	@name: loadOneQuestionsIDs;
	@desc: used to load ONE QuestionID from the database;
	@type: FUNCTION;
	@param: int-section_id;
	@lang: PHP;
	@return: int;
...
/**
	@name: loadScale;
	@desc: used to load Scalename from the database;
	@type: FUNCTION;
	@param: int-refscale;
	@lang: PHP;
	@return: String;
...
/**
	@name: loadScaleMapping;
	@desc: used to load Scalemappingdata from the database;
	@type: FUNCTION;
	@param: int-refscale;
	@lang: PHP;
	@return: Hashtable;
...
/**
	@name: loadExpectedAnswer;
	@desc: used to load the expected Answer from the database.;
	@type: FUNCTION;
	@param: int-refexpectedanswer;
	@param: int-refscale;
	@lang: PHP;
	@return: String;
...
**/
	...
	function checkLKR($participantID){
		return checkUserAnswersSection(1, $participantID);
	}
	
	function checkFRS($participantID){
		return checkUserAnswersSection(12, $participantID);
	}
